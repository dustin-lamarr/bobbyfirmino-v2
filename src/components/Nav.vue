<template>
  ...
  >
    <div class="justify-start ml-4" id="navbarLinks">
      <button class="" @click="$emit('homeView', 'homeView')" alt="go to home view">Home</button>
      <!-- <button class="pl-3 ">Profile</button> -->
      <!-- <button class="px-3 " id="logout">Logout</button> -->
      <button class="pl-2" @click="$emit('about', 'about')" alt="go to about view">About</button>
    </div>
    <div class="justify-end flex flex-row mr-4 content-center">
      <p class="">Choose a Kit:</p>
      <button class="px-2" title="Home" @click="$emit('click', 'home')" alt="change theme to home kit colors">
      ...
      <button title="Away" @click="$emit('click', 'away')" id="away" alt="change theme to away kit colors">
      ...
      <button class="pl-2" title="Third" @click="$emit('click', 'third')" alt="change theme to third kit colors">
        <svg class="inline" width="10px" height="10px">
          <rect width="10px" height="10px" style="fill: #b91331" />
        </svg>
        <svg class="inline" width="10px" height="10px">
          <rect width="10px" height="10px" style="fill: #fef667" />
        </svg>
        <svg class="inline" width="10px" height="10px">
          <rect width="10px" height="10px" style="fill: #b91331" />
        </svg>
